...
proto.user.User.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    edad: jspb.Message.getFieldWithDefault(msg, 3, 0),
    ciudad: jspb.Message.getFieldWithDefault(msg, 4, "")
  };
 ...
 * @return {string}
 */
proto.user.User.prototype.getNombre = function() {
 ...
 * @return {!proto.user.User} returns this
 */
proto.user.User.prototype.setNombre = function(value) {
 ...
 * @return {number}
 */
proto.user.User.prototype.getEdad = function() {
 ...
 * @return {!proto.user.User} returns this
 */
proto.user.User.prototype.setEdad = function(value) {
 ...
 * @return {string}
 */
proto.user.User.prototype.getCiudad = function() {
 ...
 * @return {!proto.user.User} returns this
 */
proto.user.User.prototype.setCiudad = function(value) {
